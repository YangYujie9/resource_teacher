                ...
                <div class="singal-paper" v-for="list in tableData">
                  ...
                  <div  class="singal-paper-middle">
                	...
                	<div class="singal-paper-right">
		              	<el-button type="primary" size="mini" @click="deleteFile(list.shareId)">删除</el-button>
		              </div>
                </div>
  ...
  methods: {
    ...
    getTableData:debounce(function() {
      ...
      let params = {
    	...
    	this.$http.post(`/api/open/shares/list`,{
				chapterIds: this.chapterIds,//this.chapterIds,
    ...
    deleteFile(shareId) {
      ...
      this.$confirm('确定删除该分享记录吗', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {

        this.$http.delete(`/api/open/shares/${shareId}`)
        .then((data)=>{
          if(data.status == '200') {
            this.getTableData()
